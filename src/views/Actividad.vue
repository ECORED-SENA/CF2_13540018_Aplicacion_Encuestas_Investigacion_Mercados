  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5(data-aos="fade")
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Aplicando conceptos de muestreo
        p.mb-4 Validar la comprensión de los conceptos de muestreo para calcular el tamaño de la muestra de acuerdo con las especificaciones técnicas dadas.
